...
class AWSTranscribe(AWS):
    ...
    def __init__(
        ...
        self.transcribe_client = self._create_client(
            aws_region_name="transcribe",
    ...
    def _map_language(self, language: Optional[str] = None):
        ...
        mapping = {"english": "en-US", "french": "fr-FR"}
        ...
        if language is None:
            ...
            try:
                ...
                print(
                    f"AWSTranscribe >> Error when mapping unsupported language '{language}'. Defaulting to 'en-US' (english)."
                )
                return "en-US"
    ...
    def transcribe(self, key: str, language: Optional[str] = None):
        ...
        MediaFormat = os.path.splitext(job_uri)[-1][
            1:
        ]  # retreives .ext from key and removes the dot
