...
response = api_bedrock.return_query(model_name="claude-3-haiku",
...
response = ""
for stream in api_bedrock.yield_query(model_name="claude-3-haiku",
                         user_prompt="tell me about ww2 history",
                         display=False):
